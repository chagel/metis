...
curl -fsSL -o /usr/local/bin/metis \
  https://github.com/chagel/metis/releases/download/clients%2Fmetis%2Fv0.5.3/metis-darwin-arm64
...
```sh
git tag clients/metis/v0.5.3 && git push origin clients/metis/v0.5.3
```
