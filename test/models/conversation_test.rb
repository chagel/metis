...
class ConversationTest < ActiveSupport::TestCase
  ...
  test "solo? is true while only the owner has spoken, false once a teammate does" do
  ...
  test "solo? is true in a shared team too while the owner is the only voice" do
