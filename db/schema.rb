...
ActiveRecord::Schema[8.1].define(version: 2026_07_13_000000) do
  ...
  create_table "artifact_shares", force: :cascade do |t|
    ...
    t.index ["blob_id"], name: "index_artifact_shares_on_blob_id", unique: true
    t.index ["created_by_id"], name: "index_artifact_shares_on_created_by_id"
    t.index ["team_id"], name: "index_artifact_shares_on_team_id"
    t.index ["token"], name: "index_artifact_shares_on_token", unique: true
  end
  ...
  create_table "users", force: :cascade do |t|
    t.text "about_you"
    t.boolean "auto_claim_tasks", default: true, null: false
    t.string "avatar_url"
    t.string "bridge_client"
    t.datetime "bridge_seen_at"
    t.string "bridge_token_digest"
    t.string "bridge_token_hint"
    t.datetime "created_at", null: false
  ...
  add_foreign_key "artifact_shares", "active_storage_blobs", column: "blob_id", on_delete: :cascade
  add_foreign_key "artifact_shares", "teams"
  add_foreign_key "artifact_shares", "users", column: "created_by_id"
